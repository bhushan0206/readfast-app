...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline: 'border border-neutral-300 bg-transparent hover:bg-neutral-50 text-neutral-700 focus:ring-neutral-500 dark:border-neutral-600 dark:hover:bg-neutral-800 dark:text-neutral-300',
    ghost: 'bg-transparent hover:bg-neutral-100 text-neutral-700 focus:ring-neutral-500 dark:hover:bg-neutral-800 dark:text-neutral-300',
